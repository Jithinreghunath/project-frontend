...
//       this.empListWithoutFilter_filter=data;
//     });
//   }
...
//   this.EmployeeList = this.empListWithoutFilter.filter(function (el:any){
...
// // sortResult(prop,asc){
// //   this.EmployeeList = this.empListWithoutFilter.sort(function(a,b){
// //     if(asc){
